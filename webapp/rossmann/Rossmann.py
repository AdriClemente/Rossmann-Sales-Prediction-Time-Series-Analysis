...
class Rossmann(object):
    ...
    def data_cleaning(self, df1):
        ...
        # Altera o estilo dos nomes das colunas de CamelCase para SnakeCase utilizando a funcao abaixo.
        snakecase = lambda x: inflection.underscore(x)

        # A funcao map executa a funcao snakecase em todas as palavras da lista cols_old. A saida desta funcao eh convertida em uma 
    ...
    def feature_engineering(self, df2):
        ...
        # 3.0 PASSO 3.0 - FILTRAGEM DAS VARIAVEIS
        ## 3.1. Filtragem das Linhas
        df2 = df2[df2['open'] != 0]

        ## 3.2. Selecao das Colunas e das Linha
    ...
    def get_prediction(self, model, original_data, test_data):
        ...
        # No comando abaixo o parametro date_format='iso' = ISO8601 = eh uma norma internacional para representacao de data e hora emitida pela Organizacao Internacional para Padronizacao.
